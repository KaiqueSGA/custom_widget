...
const convertRange_1 = __importDefault(require("./common/convertRange"));
/**
...
function convert(oldWidget) {
    ...
    const newStructure = {
        ...
        display: {
            ...
            range: (0, convertRange_1.default)(oldDisplay),
        ...
        for (const item of oldWidget.data) {
            ...
            for (const variable of item.variables) {
                ...
                if (oldDisplay.vars_formula?.[key]) {
                    newStructure.display.formula = (0, convertFormula_1.default)(oldDisplay.vars_formula?.[key]);
                }

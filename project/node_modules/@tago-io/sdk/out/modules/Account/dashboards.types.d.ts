...
declare type ResourceTag = `tags.${string}`;
declare type ResourceParam = `param.${string}`;
declare type DeviceResourceView = ResourceTag | ResourceParam | "name" | "id" | "bucket_name" | "network_name" | "connector_name" | "connector" | "network" | "bucket" | "last_input" | "created_at" | "active";
 ...
 */
declare type EditDeviceResource = {
    device: GenericID;
    name?: string;
    active?: boolean;
} & {
...
declare type EditDataModel = PostDataModel & {
    id: GenericID;
};
...
export { DashboardQuery, PublicKeyResponse, DevicesRelated, AnalysisRelated, DashboardCreateInfo, DashboardInfo, WidgetInfo, widgetOverwrite, PostDataModel, EditDataModel, EditDeviceResource, EditResourceOptions, GetDataModel, };

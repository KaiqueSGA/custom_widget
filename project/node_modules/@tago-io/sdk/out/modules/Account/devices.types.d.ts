...
declare type DeviceCreateInfo = DeviceCreateInfoLegacy | DeviceCreateInfoMutable | DeviceCreateInfoImmutable;
declare type DeviceEditInfo = Partial<Omit<DeviceCreateInfo, "chunk_period" | "type"> & {
    chunk_retention: number;
}>;
...
interface ListDeviceTokenQuery extends Query<DeviceTokenDataList, "name" | "permission" | "serie_number" | "last_authorization" | "created_at"> {
}
...
export { DeviceQuery, DeviceCreateInfo, ConfigurationParams, DeviceInfo, DeviceEditInfo, DeviceCreateResponse, DeviceListItem, DeviceTokenDataList, DeviceChunkData, ListDeviceTokenQuery, DeviceChunkParams, DeviceChunkCopyResponse, };

 ...
 */
declare type UsageStatistic = Partial<Record<BillingService, number>> & {
    /**
...
declare type resourceNameType = "action" | "am" | "analysis" | "connector" | "dashboard" | "device" | "dictionary" | "network" | "profile" | "run" | "runuser";
...
export type { ProfileListInfo, ProfileAddOns, ProfileInfo, UsageStatistic, AuditLog, AuditLogFilter, AddonInfo, ProfileSummary, StatisticsDate, };

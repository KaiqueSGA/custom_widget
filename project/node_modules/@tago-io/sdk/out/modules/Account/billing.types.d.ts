...
declare type BillingPlan = "free" | "starter" | "scale";
declare type BillingService = "input" | "output" | "analysis" | "data_records" | "sms" | "email" | "run_users" | "push_notification" | "file_storage";
declare type BillingAddOn = "mobile" | "custom_dns";
declare type BillingServiceSubscription = {
    limit: number;
};
declare type BillingSubscriptionServices = Record<BillingService, BillingServiceSubscription>;
declare type BillingSubscriptionAddOns = Record<BillingAddOn, GenericID[]>;
declare type BillingPaymentError = {
    /**
...
declare type BillingPaymentPastDue = {
    /**
...
declare type BillingSubscription = {
    /**
     * Account ID.
     */
    account: GenericID;
...
declare type BillingEditSubscription = {
    /**
     * New account plan.
     *
...
declare type BillingServiceSubscriptionSchedule = Record<BillingService, BillingServiceSubscription & {
    /**
     * Amount of proportional change the service's allocation will undergo.
     */
    proportional_change?: number | undefined;
}>;
declare type BillingSubscriptionSchedule = {
    /**
...
declare type BillingServicePrice = {
    /**
...
declare type BillingAllServicePrices = Record<BillingService, BillingServicePrice[]>;
declare type BillingPlanPrices = Array<{
    /**
     * Plan name.
     */
    name: BillingPlan;
...
declare type BillingAddOnPrices = Array<{
    /**
     * Add-on name.
     */
    name: BillingAddOn;
...
declare type BillingPaymentMethodCard = {
    /**
...
declare type BillingPaymentMethodBalance = {
    /**
...
declare type BillingPaymentMethod = {
    /**
...
declare type BillingSubscriptionSummary = {
    /**
...
declare type BillingPaymentHistoryEntry = {
    /**
...
declare type BillingInformation = {
    /**
     * Account ID.
     */
    account: GenericID;
...
declare type BillingEditInformation = Partial<Omit<BillingInformation, "account" | "updated_at" | "payment_method">>;
declare type BillingResourceAllocationServices = Record<BillingService, number>;
declare type BillingProfileResourceAllocation = {
    /**
     * Profile ID.
     */
    profile: GenericID;
...
declare type BillingResourceAllocation = BillingProfileResourceAllocation[];
declare type BillingEditResourceAllocation = Array<Partial<Omit<BillingProfileResourceAllocation, "updated_at">>>;
export type { BillingPlan, BillingService, BillingAddOn, BillingServiceSubscription, BillingSubscriptionServices, BillingSubscriptionAddOns, BillingPaymentError, BillingPaymentPastDue, BillingSubscription, BillingEditSubscription, BillingServiceSubscriptionSchedule, BillingSubscriptionSchedule, BillingSchedule, BillingServicePrice, BillingPlanPrices, BillingAddOnPrices, BillingPrices, BillingPaymentMethodCard, BillingPaymentMethodBalance, BillingCoupon, BillingPaymentMethod, BillingSubscriptionSummary, BillingPaymentHistoryEntry, BillingInformation, BillingEditInformation, BillingResourceAllocationServices, BillingResourceAllocation, BillingProfileResourceAllocation, BillingEditResourceAllocation, };

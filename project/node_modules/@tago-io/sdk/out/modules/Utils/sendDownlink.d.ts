 ...
 */
declare function handleDownlinkError(error: AxiosError): Promise<AxiosResponse<any, any>>;
/**
 ...
 * @returns
 */
declare function sendDownlink(account: Account, device_id: string, dn_options: DownlinkOptions): Promise<string>;
export default sendDownlink;
export { handleDownlinkError };
//# sourceMappingURL=sendDownlink.d.ts.map
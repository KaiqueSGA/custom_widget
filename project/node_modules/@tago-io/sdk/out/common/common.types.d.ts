...
declare type LocationGeoJSON = {
    type: "Point";
    coordinates: number[];
};
declare type LocationLatLng = {
    lat: number;
    lng: number;
};
/**
 ...
 */
declare type DataCreate = Required<Pick<Data, "variable">> & Partial<Omit<Data, "id" | "device" | "origin" | "location" | "time" | "created_at"> & {
    /**
     * Location for the data value.
     */
 ...
 */
declare type DataEdit = Required<Pick<Data, "id">> & Partial<Pick<DataCreate, "value" | "group" | "serie" | "unit" | "metadata" | "time" | "location">>;
interface TagsObj {
    key: string;
    value: string;
}
...
export { Data, DataCreate, DataEdit, TagsObj, Query, Base64, GenericID, GenericToken, PermissionOption, ExpireTimeOption, ExportOption, Conditionals, TokenCreateResponse, RunTypeOptions, RefType, ListTokenQuery, TokenData, TokenDataList, RecursivePartial, };
